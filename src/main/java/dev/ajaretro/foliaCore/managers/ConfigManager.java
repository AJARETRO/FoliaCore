...
public class ConfigManager {
    ...
    private static final String[] REGISTERED_COMMANDS = {
            "actionbarmsg", "afk", "afkcheck", "air", "alert", "aliaseditor", "anvil", "anvilrepaircost", "armoreffect", "armorstand", "attachcommand", "autorecharge",
            "back", "balance", "baltop", "ban", "banlist", "bbroadcast", "blockcycling", "blockinfo", "blocknbt", "book", "bossbarmsg", "broadcast",
            "burn", "cartographytable", "charges", "chat", "chatcolor", "checkaccount", "checkban", "checkcommand", "checkexp", "checkperm", "cheque", "clear",
            "clearchat", "clearender", "colorlimits", "colorpicker", "colors", "compass", "condense", "counter", "cplaytime", "ctellraw", "ctext", "cuff",
            "customrecipe", "database", "dback", "dialogs", "disableenchant", "dispose", "distance", "donate", "down", "dsign", "dye", "editctext",
            "editlocale", "editplaytime", "editwarnings", "editwarp", "effect", "enchant", "ender", "endgateway", "entityinfo", "entitynbt", "exp", "ext",
            "falldistance", "fc", "feed", "findbiome", "fixchunk", "flightcharge", "fly", "flyc", "flyspeed", "gamerule", "generateworth", "getbook",
            "give", "giveall", "glow", "gm", "god", "grindstone", "groundclean", "haspermission", "hat", "head", "heal", "helpop",
            "hideflags", "hologram", "hologrampages", "home", "homes", "hunger", "ic", "ifoffline", "ifonline", "ignore", "importfrom", "importoldusers",
            "info", "inv", "invcheck", "invlist", "invload", "invremove", "invremoveall", "invsave", "ipban", "ipbanlist", "item", "itemcmdata",
            "itemframe", "iteminfo", "itemlore", "itemname", "itemnbt", "jail", "jailedit", "jaillist", "jump", "kick", "kill", "killall",
            "kit", "kitcdreset", "kiteditor", "kitusagereset", "lastonline", "launch", "lfix", "list", "lockip", "loom", "mail", "mailall",
            "maintenance", "maxhp", "maxplayers", "me", "merchant", "migratedatabase", "mirror", "mobhead", "money", "more", "msg", "mute",
            "mutechat", "nameplate", "near", "nick", "notarget", "note", "openbook", "oplist", "options", "panimation", "particlepicker", "patrol",
            "pay", "ping", "placeholders", "playercollision", "playtime", "playtimetop", "point", "portals", "pos", "preview", "prewards", "ptime",
            "purge", "pweather", "rankdown", "rankinfo", "ranklist", "rankset", "rankup", "realname", "recipe", "reload", "removehome", "removeuser",
            "removewarp", "repair", "repaircost", "replaceblock", "reply", "resetback", "resetdbfields", "ride", "rt", "sameip", "saturation", "saveall",
            "saveditems", "sc", "scale", "scan", "scavenge", "schedule", "se", "search", "seen", "select", "sell", "sendall",
            "server", "serverlinks", "serverlist", "servertime", "setenchantworth", "setfirstspawn", "sethome", "setmotd", "setrt", "setspawn", "setwarp", "setworth",
            "shadowmute", "shakeitoff", "shoot", "silence", "silentchest", "sit", "skin", "smite", "smithingtable", "solve", "sound", "spawn",
            "spawner", "spawnereditor", "spawnmob", "speed", "staffmsg", "stats", "statsedit", "status", "stonecutter", "sudo", "suicide", "switchplayerdata",
            "tablistupdate", "tempban", "tempipban", "tfly", "tgod", "time", "titlemsg", "toast", "top", "tp", "tpa", "tpaall",
            "tpaccept", "tpahere", "tpall", "tpallworld", "tpbypass", "tpdeny", "tphere", "tpo", "tpohere", "tpopos", "tppos", "tps",
            "tree", "trim", "unban", "unbreakable", "uncondense", "unjail", "unloadchunks", "unmute", "unmutechat", "usermeta", "util", "vanish",
            "vanishedit", "version", "viewdistance", "voteedit", "votes", "votetop", "walkspeed", "warn", "warnings", "warp", "warpgroups", "weather",
            "workbench", "world", "worth", "worthlist"
    };
